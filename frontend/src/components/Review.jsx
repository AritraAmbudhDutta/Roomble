...
export const Review = () => {
    ...
    const [cuser, setcUser] = useState({ name: "User Name", image: "/sampleUser_Img.png" }); // State to store the user being reviewed
    ...
    return (
        <>
            <div className='review-container'>
                ...
                <div className="review-user-details">
                    ...
                    <div className="review-user-image">
                        <img src={cuser.image} alt="" /> {/* Display the profile picture of the user */}
                    </div>
                </div>
            </div>
            <div className="review-form">
                ...
                ></textarea> {/* Textarea for entering the review */}
                <button className='review-btn' onClick={handleClick}>Submit</button> {/* Submit button */}
            </div>
        </>
    );
};
