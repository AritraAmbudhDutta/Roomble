        ...
        {showFlatmates ? (
          <div className="page-content animate-flip">
            <DragDropContext
              ...
              onDragEnd={(result) => handleDragEnd(result, handleFlatmatesDragEnd)}
            >
              <Droppable droppableId="delete-zone">
                {(provided, snapshot) => (
                  <div
                    className={`delete-zone ${isDragging ? 'visible' : 'hidden'}`}
          ...
          <div className="page-content animate-flip">
            <DragDropContext
              onDragStart={handleDragStart}
              onDragEnd={(result) => handleDragEnd(result, handlePropertiesDragEnd)}
            >
              <Droppable droppableId="delete-zone">
                {(provided, snapshot) => (
                  <div
